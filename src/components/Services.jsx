const services = [
  {
    title: 'Parent & Carer Support Hub',
    text: 'A welcoming space for parents and carers to connect, share experiences, and find peer support. You are never alone in navigating the SEND landscape.',
  ...
  {
    title: 'SEN Consultancy & Advocacy',
    text: 'Expert guidance through EHCPs, school processes, and local authority systems. We advocate alongside families to ensure children receive the support they deserve.',
  ...
  },
  {
    ...
    text: 'Practical, accessible workshops covering neurodiversity, anxiety management, and building resilience — designed for families and professionals alike.',
  ...
  {
    title: "KT's Place Special Child Days",
    text: 'Joyful, inclusive events celebrating neurodiverse children in a safe environment — creating magical memories for children and precious moments of rest for their families.',
    ...
    <section id="services" style={{ background: 'white', padding: '100px 32px' }}>
      <div style={{ maxWidth: 1160, margin: '0 auto' }}>
        <div className="reveal" style={{ textAlign: 'center', marginBottom: 60 }}>
          ...
          <p style={{ color: '#4A6E75', fontSize: '1.05rem', maxWidth: 460, margin: '14px auto 0', lineHeight: 1.65 }}>Practical, heartfelt support tailored to the real needs of SEND families.</p>
        </div>
